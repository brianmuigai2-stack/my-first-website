/* ===========================
   ...
   const translations = {
    en: {
      ...
      'hero-subtitle': 'Full-Stack Developer | React Enthusiast | Problem Solver',
    ...
    es: {
      ...
      'sunset': 'Atardecer',
      'galaxy': 'Galaxia',
      'hero-title': 'Hola, soy Brian 👋',
      'hero-subtitle': 'Desarrollador Full-Stack | Entusiasta de React | Solucionador de Problemas',
      'view-projects': 'Ver Proyectos',
      'contact-me': 'Contáctame',
      'about-title': 'Acerca de Mí',
      'about-text': 'Soy un estudiante apasionado de ingeniería de software enfocado en construir aplicaciones web limpias y responsivas. Disfruto resolviendo problemas con código, contribuyendo a código abierto y aprendiendo continuamente frameworks modernos. Actualmente explorando React y desarrollo full-stack para crear experiencias digitales impactantes.',
      ...
      'service-frontend-feature2': 'Diseño Responsivo',
      'service-frontend-feature3': 'Optimización de Rendimiento',
      'service-backend': 'Desarrollo Back-End',
      'service-backend-desc': 'Construyendo aplicaciones robustas del lado del servidor con Node.js, Express e integración de bases de datos.',
      'service-backend-feature1': 'APIs Node.js/Express',
      'service-backend-feature2': 'Diseño de Base de Datos',
      'service-backend-feature3': 'Sistemas de Autenticación',
      'service-uiux': 'Diseño UI/UX',
      'service-uiux-desc': 'Diseñando interfaces hermosas y centradas en el usuario que proporcionen experiencias de usuario excepcionales.',
      'service-uiux-feature1': 'Wireframing & Prototipado',
      'service-uiux-feature2': 'Investigación de Usuario',
      'service-uiux-feature3': 'Sistemas de Diseño',
    ...
    fr: {
      ...
      'sunset': 'Coucher',
      'galaxy': 'Galaxie',
      'hero-title': 'Salut, je suis Brian 👋',
      'hero-subtitle': 'Développeur Full-Stack | Passionné de JavaScript | Résolveur de Problèmes',
      'view-projects': 'Voir Projets',
      'contact-me': 'Contactez-moi',
      'about-title': 'À Propos',
      'about-text': 'Je suis un étudiant passionné en ingénierie logicielle axé sur la création d\'applications web propres et responsives. J\'aime résoudre des problèmes avec du code, contribuer à l\'open source et apprendre continuellement des frameworks modernes. J\'explore actuellement React et le développement full-stack pour créer des expériences numériques percutantes.',
      'projects-label': 'Projets',
      'technologies-label': 'Technologies',
      'commits-label': 'Commits',
      'services-title': 'Services que j\'offre',
      'service-frontend': 'Développement Front-End',
      'service-frontend-desc': 'Création d\'applications web responsives et interactives utilisant React, Vue.js et frameworks JavaScript modernes.',
      'service-frontend-feature1': 'Développement React/Vue.js',
      'service-frontend-feature2': 'Design Responsif',
      'service-frontend-feature3': 'Optimisation des Performances',
      'service-backend': 'Développement Back-End',
      'service-backend-desc': 'Construction d\'applications robustes côté serveur avec Node.js, Express et intégration de bases de données.',
      'service-backend-feature1': 'APIs Node.js/Express',
      'service-backend-feature2': 'Conception de Base de Données',
      'service-backend-feature3': 'Systèmes d\'Authentification',
      'service-uiux': 'Design UI/UX',
      'service-uiux-desc': 'Conception d\'interfaces magnifiques et centrées sur l\'utilisateur qui fournissent des expériences utilisateur exceptionnelles.',
      'service-uiux-feature1': 'Wireframing & Prototypage',
      'service-uiux-feature2': 'Recherche Utilisateur',
      'service-uiux-feature3': 'Systèmes de Design',
      ...
      'subscribe': 'S\'abonner',
      'privacy-notice': 'Je respecte votre vie privée. Désabonnez à tout moment. Pas de spam, jamais.',
    ...
    de: {
      ...
      'service-uiux': 'UI/UX Design',
      'service-uiux-desc': 'Gestaltung schöner, benutzerzentrierter Interfaces, die herausragende Benutzererlebnisse bieten.',
      'service-uiux-feature1': 'Wireframing & Prototyping',
      ...
      'privacy-notice': 'Ich respektiere Ihre Privatsphäre. Jederzeit abbestellbar. Kein Spam, niemals.',
    ...
    zh: {
      ...
      'sunset': '日落',
      'galaxy': '银河',
      'hero-title': '你好，我是Brian 👋',
      'hero-subtitle': '全栈开发者 | React爱好者 | 问题解决者',
      'view-projects': '查看项目',
      'contact-me': '联系我',
      'about-title': '关于我',
      'about-text': '我是一名充满热情的软件工程专业学生，专注于构建干净、响应式的Web应用程序。我喜欢用代码解决问题，为开源做贡献，并不断学习现代框架。目前正在探索React和全栈开发，以创造有影响力的数字体验。',
      'projects-label': '项目',
      'technologies-label': '技术',
      'commits-label': '提交',
      'services-title': '我提供的服务',
      'service-frontend': '前端开发',
      'service-frontend-desc': '使用React、Vue.js和现代JavaScript框架创建响应式、交互式Web应用程序。',
      'service-frontend-feature1': 'React/Vue.js开发',
      'service-frontend-feature2': '响应式设计',
      'service-frontend-feature3': '性能优化',
      'service-backend': '后端开发',
      'service-backend-desc': '使用Node.js、Express和数据库集成构建强大的服务器端应用程序。',
      'service-backend-feature1': 'Node.js/Express API',
      'service-backend-feature2': '数据库设计',
      'service-backend-feature3': '身份验证系统',
      'service-uiux': 'UI/UX设计',
      'service-uiux-desc': '设计美观、以用户为中心的界面，提供卓越的用户体验。',
      'service-uiux-feature1': '线框图和原型',
      'service-uiux-feature2': '用户研究',
      'service-uiux-feature3': '设计系统',
      'get-quote': '获取报价 →',
      'skills-title': '技能',
      'projects-title': '项目',
      'filter-all': '全部',
      ...
      'subscribe': '订阅',
      'privacy-notice': '我尊重您的隐私。随时可以取消订阅。绝不发送垃圾邮件。',
